...
Miranda's shape is markedly triaxial: $240 \times 234.2 \times 232.9\,\mathrm{km}$, determined
from limb coordinates in the Voyager 2 images
([Thomas 1988](literatur:thomas-1988)). The volume-equivalent spherical radius from these three
semi-axes is $\sqrt[3]{240 \cdot 234.2 \cdot 232.9} = 235.68\,\mathrm{km}$ (derivation) – the
value the catalog also carries, close to the $235.8\,\mathrm{km}$ independently determined from
radio tracking and the IAU report in the table below. Unlike the Cassini-tracked Saturn moons,
Miranda's mass parameter comes from a single flyby trajectory plus decades of ground-based
astrometry ([Jacobson 2014](literatur:jacobson-2014)), carrying a much larger relative
uncertainty.

| Quantity | Value | Uncertainty | Method | Source |
|---|---|---|---|---|
| $GM$ | $4.3\,\mathrm{km^3\,s^{-2}}$ | $0.2\,\mathrm{km^3\,s^{-2}}$ | flyby trajectory and astrometry | [JPL SSD satellite data](quelle:jpl-satelliten) |
| Radius (radio tracking/IAU) | $235.8\,\mathrm{km}$ | $0.7\,\mathrm{km}$ | limb coordinates | [JPL SSD satellite data](quelle:jpl-satelliten) |
| Semi-axes (triaxial) | $240 \times 234.2 \times 232.9\,\mathrm{km}$ | – | Voyager 2 limb coordinates | [Thomas 1988](literatur:thomas-1988) |
| $\bar\rho$ | $1178\,\mathrm{kg\,m^{-3}}$ | $53\,\mathrm{kg\,m^{-3}}$ | from $GM$ and radius | [JPL SSD satellite data](quelle:jpl-satelliten) |
| Geometric albedo (visual) | $0.32$ | – | fact sheet | [Uranian Satellite Fact Sheet](quelle:nssdc-uranusmonde) |
| Geometric albedo (K band) | $0.25$ | $0.03$ | HST photometry | [Karkoschka 2001](literatur:karkoschka-2001) |

With the catalog mass ($6.6 \cdot 10^{19}\,\mathrm{kg}$, from the same Voyager-era solution) and
...
barely half the moon; no northern close-up exists to this day.

## Interior

In a simple two-component model of water ice ($917\,\mathrm{kg\,m^{-3}}$) and silicate rock
($3000\,\mathrm{kg\,m^{-3}}$, the same simplified model as for [Iapetus](objekt:iapetus)),
Miranda's density corresponds to a rock mass fraction of about a third (derivation) – markedly
less than for the larger, denser Uranian moons. Whether the body is differentiated or ice and
rock remain mixed cannot be settled without a dedicated gravity measurement (moment-of-inertia
factor; see
[Interior structure](thema:innerer-aufbau)). What is clear is that Miranda was, at some point in
its history, considerably warmer than radiogenic heating alone can explain: fault geometries at
Arden Corona (see Surface) imply a brittle–ductile transition depth of 6.7 to 9.0 km, a thermal
gradient of 6 to 25 K/km, and a surface heat flux of 31 to 112 mW/m² – comparable to the present
...
([Tittemore and Wisdom 1990](literatur:tittemore-1990)), while a more recent model finds tidal
heat flows exceeding 100 mW/m² during the same episode, sufficient to produce the young coronae
([Ćuk et al. 2020](literatur:cuk-2020); on the basics of tidal heating, see
...
residual oceans ([Castillo-Rogez et al. 2023](literatur:castillo-rogez-2023)). Both studies
therefore agree that a present ocean is unlikely, though an earlier, since-refrozen one remains an
...
of the Elsinore region lies Verona Rupes, a scarp several kilometres high, estimated at 5 to
10 km from the Voyager 2 imagery itself ([Thomas 1988](literatur:thomas-1988)); later, less
...
orbits turned chaotic ([Tittemore and Wisdom 1989](literatur:tittemore-1989); on the chaotic
behaviour in general, [Dermott et al. 1988](literatur:dermott-1988)). A more recent dynamical
model of the whole Uranian system questions this attribution and instead credits Miranda's current
inclination to secular effects of the younger 5:3 resonance between Ariel and Umbriel
([Ćuk et al. 2020](literatur:cuk-2020)) – a question the field has not yet settled (see Open
questions). Today Miranda is in no mean-motion resonance with any neighbouring moon.

Like all 21 moons in the model, Miranda rotates in a bound state: its rotation period equals its
sidereal orbital period, with a residual deviation of only $0.118 \cdot 10^{-6}$ relative, which
lets the direction to Uranus drift across the map by 1.1° per century; the libration in latitude
equals the angle between the rotation pole and the orbital normal and amounts to ±4.3° for
Miranda – markedly more than for the Moon (±6.7° at epoch) or the other Uranian moons, but, as for
those, fixed in the data set because the orbital node does not precess (figures as in
...
- **Which resonance explains Miranda's current orbital inclination?** The classical 3:1 resonance
  with Umbriel ([Tittemore and Wisdom 1989](literatur:tittemore-1989)) and the more recent
  attribution to the 5:3 resonance between Ariel and Umbriel
  ([Ćuk et al. 2020](literatur:cuk-2020)) disagree on the cause, not merely on modelling details;
  which account better matches the system's full orbital history is not settled.
- **Cause and age of the coronae.** Convection in the ice shell explains their location and
  deformation well ([Hammond and Barr 2014](literatur:hammond-2014)); comparison with the
  better-surveyed mid-sized moons of Saturn and Pluto instead attributes the coronae to antipodal
  diapiric upwelling of warm ice, like more subtly expressed structures on Enceladus and Dione
  ([Schenk and Moore 2020](literatur:schenk-2020)); neither rules out a more violent origin via
  crustal disruption and partial reassembly after impact, and all fit the observed crater ages
...
- **Orbital reference:** Like the other four large Uranian moons, Miranda moves in the
  `parentEquator` reference on [Uranus'](objekt:uranus) equatorial plane, with osculating Horizons
  elements at epoch J2000 ($a = 129871.76\,\mathrm{km}$, $e = 0.00151$). The inclination in the
  data set ($i = 175.572^\circ$) is measured against Uranus' pole, not against its equatorial
  plane in the everyday sense: $180^\circ - i = 4.43^\circ$ is the orbital inclination as usually
  quoted (derivation), against the fact sheet's $4.34^\circ$ – a small, unresolved 0.09° gap
  between the two sources (convention as under [Orbital elements](thema:bahnelemente)).
...
- **Apsidal rate:** `lpDot` ($2003.3460^\circ$ per century) follows the project's two-term
  ...
  derivation matches the data-set value exactly), even though `nodeDot` itself stays at zero for
  an entirely different, empirical reason.
- **Orbital period:** From `LDot` follows $360^\circ/\dot L = 1.413479\,\mathrm{d}$; the data
  panel shows the Kepler orbital period computed from the semi-major axis and the masses,
  $1.413995\,\mathrm{d}$, about 0.0365 % longer. `rotationPeriodH` ($-33.92350\,\mathrm{h}$)
  matches $360^\circ/\dot L \cdot 24$ almost exactly – the bound rotation described in Orbit,
  rotation and dynamics above.
- **Pole:** $257.43^\circ / -15.08^\circ$ is fixed in the data set, even though the IAU report
...
- **Shadows:** Miranda is among up to four spherical occluders drawn at once (`MAX_OKKLUDER`)
  whenever it has the largest rendered angular radius among the Uranian moons; among the five
  large moons, Oberon, the smallest, is always the one left out (figures as in
  [Eclipses](thema:finsternis)).
- **Scale:** Miranda is a satellite (`isSatellite`, its `parent` is Uranus, not the Sun); its
  orbital radius therefore scales, like its own and Uranus' radius, with `sizeScale`, not with the
  distance compression applied to the planetary orbits. Further simplifications:
