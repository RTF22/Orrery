...
entschieden nach Abnahme 4d-3 §8. Beschreibende Zusätze im Feld `erschienen` (Herausgeber, Zugriffs- oder Online-Datum, Art einer Seite) stehen wie die Zeitschriftennamen auf Englisch, ohne Ausnahme; Eigennamen von Verlagen und Einrichtungen bleiben in der Originalsprache (Schlussprüfung 4d-4).
